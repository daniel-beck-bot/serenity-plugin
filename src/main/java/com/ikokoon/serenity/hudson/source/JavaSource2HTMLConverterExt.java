...
/**
 * This class just extends the Java2HTML converter and adds a background colour where the lines were executed.
 * Unfortunately most of the interesting methods were private so there is a lot of copy and paste, pity, se la vie.
 *
...
public class JavaSource2HTMLConverterExt extends JavaSource2HTMLConverter {
    ...
    public JavaSource2HTMLConverterExt(Class<Package, Method> klass) {
        super();
        this.klass = klass;
    }
    ...
    private boolean getCovered(final Class<Package, Method> klass, final double lineNumber) {
