...
public final class Thread {
     ...
     */
    public static void waitForThreads(final Collection<java.lang.Thread> threads) {
        if (threads == null) {
    ...
    public static void waitABit(final long milliSeconds) {
        try {
            java.lang.Thread.currentThread().wait(milliSeconds);
        } catch (final InterruptedException e) {
            java.lang.Thread.currentThread().interrupt();
            throw new RuntimeException(e);
        }
    ...
    public static synchronized void destroy() {
        ...
        try {
            int maxRetryCount = MAX_RETRY_COUNT;
            while (!EXECUTOR_SERVICE.awaitTermination(3, TimeUnit.SECONDS) && maxRetryCount-- > 0) {
